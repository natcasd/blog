    ...
    <div className="px-4 md:px-16 lg:px-12 mx-auto max-w-4xl">
      ...
      <div className="text-center mb-6">
        ...
        <div className="flex flex-col md:flex-row justify-center items-center space-y-4 md:space-y-0 md:space-x-4">
          <Image src={hotdog1} alt="Hotdog 1" width={400} height={300} className="w-full h-auto"/>
          <Image src={hotdog2} alt="Hotdog 2" width={400} height={300} className="w-full h-auto"/>
          <Image src={hotdog3} alt="Hotdog 3" width={412} height={300} className="w-full h-auto"/>
        </div>
      </div>
