...
<div className="px-4 md:px-10 flex justify-center items-center"> 
    ...
    </div>      <h1 className="text-xl md:text-3xl font-bold mb-4">Nathan's Food Tour of London and Surrounding Areas</h1>
      ...
      <p className="indent-8">
        ...
        sausage rolls at{" "}
        <a className="text-blue-500 underline hover:text-blue-700" href="https://thegingerpig.co.uk/pages/borough-market">
          The Ginger Pig
        </a>
        .
      </p>
      ...
      <p className="indent-8">
        ...
        <a className="text-blue-500 underline hover:text-blue-700" href="https://theblacklock.com/restaurants/blacklock-soho/">
          Blacklock Soho
        </a>{" "}
      ...
      <p className="indent-8">
        ...
        <a className="text-blue-500 underline hover:text-blue-700" href="https://www.tayyabs.co.uk/">Tayyabs</a>, a byob punjabi spot in
        East London. We brought stella tallboys and the cold light beer paired
        wonderfully with the spicy, spiced food. It was also incredibly cheap.
      </p>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 my-6">
    <div className="h-96 overflow-hidden">
        <Image src={tayyabs1} alt="dining at tayyabs" className="w-full h-full object-contain"/>
    </div>
    <div className="h-96 overflow-hidden">
        <Image src={tayyabs2} alt="lamb chop at tayyabs" className="w-full h-full object-contain"/>
    </div>
</div>
      <p className="indent-8">
      ...
      <p className="indent-8">
        ...
        meal at <a  className="text-blue-500 underline hover:text-blue-700" href="https://stjohnrestaurant.com/">St. John Smithfield</a>.
        This was a meal I had been anticipating for a long time, through various
        youtube videos and following their instagram. For those of you who
        haven't checked it out, I recommend. The captions for their photos have
        to be the best food writing out there. Anyway, we had dinner in the
    ...
    <div className="w-full md:w-1/2 px-1 md:px-2">
      ...
      <p className="indent-8">
        ...
        <a  className="text-blue-500 underline hover:text-blue-700" href="https://bratrestaurant.co.uk/">Brat</a>, specifically Brat's
        Climpson Arch. This is another big London restaurant, but we didn't get
        a reservation far enough in advance for the main location, so we had to
        go to this weird pop up venue that was under an arch. Aside, I love the
        chairs they have in Brat, my mom says they are called Thonet Bentwood
        but I can't find the specific one online. They have a large emphasis on
        open fire cooking, and they do most if not all of their cooking on it. I
        sat facing the grill and it was really entertaining to watch, my sister
        had to move seats though because she was grossed out by the chefs
        touching the food. I was really excited for the turbot that they prepare
        like they do in the{" "}
        <a  className="text-blue-500 underline hover:text-blue-700" href="https://www.youtube.com/watch?v=gWhTglFhuv0">Basque country</a>
    ...
    <Image src={bratmeal} height={400} alt="whole meal at brat"></Image>
      ...
      <p className="indent-8">
        ...
        <a  className="text-blue-500 underline hover:text-blue-700"href="https://www.ritasdining.com/"> Rita's Dining</a>, which I know
        from
        <a  className="text-blue-500 underline hover:text-blue-700" href="https://www.youtube.com/watch?v=-GWItHgAfPA">
          {" "}
          this sick chef's night out video{" "}
        </a>{" "}
        and
        <a  className="text-blue-500 underline hover:text-blue-700" href="https://www.youtube.com/watch?v=O5hNWSPMDpQ"> Willy's pies</a>,
        whose Instagram led me to a lot of the places I went on the trip. I also
        didn't get a great full english at a lowkey cafe (breakfast set), but I
        did get a pretty great one at an inn we were at in the Cotswolds. I also
        didn't get to go to <a className="text-blue-500 underline hover:text-blue-700" href="https://baolondon.com/">Bao London</a>, but
        I had mixed feelings about it anyway.
      </p>
      <p className="indent-8">
        ...
        <a className="text-blue-500 underline hover:text-blue-700" href="https://www.youtube.com/watch?v=dB22Qf0vhn4">this report</a>. I
        regret not ordering more, we were saving space for a pub at our final
        destination that ended up being pretty shitty.
      </p>
      <div className="flex flex-col md:flex-row justify-center items-center my-6">
    <div className="w-full md:w-1/2 px-1 md:px-2 mb-4 md:mb-0">
