...
<div className="px-4 md:px-10 flex justify-center items-center"> 
    ...
    <h1 className="text-3xl md:text-4xl font-bold text-center">Vehicles for drinking</h1>
      </div>
      <div className="px-4 md:px-16 lg:px-12 mx-auto max-w-4xl py-4">
    <p className="indent-8 mb-4">Americans have once again got it all wrong.</p>
    ...
    <p className="indent-8 mb-4">
        The ultimate when it comes to this drinking experience can be found in Japanese highball glasses. Although, there is a popular brutish mug type glass that highballs will be served in in izakayas, in higher end places I believe it is common to see these ultra-thin <a href="https://www.amazon.com/Sasaki-G096-T285-Highball-Authentic-Dishwasher/dp/B09DXY64QP?th=1" className="text-blue-500 underline hover:text-blue-700">glasses</a>. These are as thin as possible, so they achieve the peak experience of drinking for all of the aforementioned reasons. The satisfaction of drinking out of these is well depicted by this popular tiktoker.
    </p>
